(ns pl.tomaszgigiel.palestra.codewars.skyscrapers6
  (:gen-class))

; https://www.codewars.com/kata/6-by-6-skyscrapers/train/clojure
...
; From left-to-right all six buildings must be visible and no building may hide behind another building:
